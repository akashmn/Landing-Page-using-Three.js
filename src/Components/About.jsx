  ...
  return (
    <div className="py-3 flex flex-row">
        <div className="h-screen max-sm:h-[2000px] w-full bg-green-600 px-[250px] max-sm:px-[5px] py-28 max-sm:py-8 flex flex-row max-sm:flex-col items-center justify-between">
            ...
            <div className="flex flex-col items-center justify-center gap-10 ml-52 max-sm:ml-7 max-sm:p-3">
                <p className="text-5xl font-bold tracking-wide">Presenting Ourselves!</p>
                <p className="text-lg max-sm:text-lg tracking-wider">Our team of passionate designers, developers, and marketing specialists collaborates to bring your vision to life. We create beautiful, user-friendly websites and mobile apps, craft compelling design elements that elevate your brand, and implement data-driven digital marketing strategies to reach your target audience.</p>
                <p className="text-lg max-sm:text-lg tracking-wider">At Qmark Technolabs, we offer a spectrum of services designed to meet the diverse needs of businesses today.</p>
            </div>
        </div>
    </div>
  )
