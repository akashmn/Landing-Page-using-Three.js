...
const About = () => {
  return (
    <div className="py-3">
        <div className="h-screen w-full bg-green-600 px-36">
            <div className="rotate-[-15deg] h-[260px] w-[230px] border-2 p-3 bg-white border-black rounded-2xl flex flex-col items-center justify-start gap-2 hover:bg-sky-500 transition-all duration-300">
